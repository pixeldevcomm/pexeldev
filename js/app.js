(() => {
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.from(".design-product__title", {
        scrollTrigger: ".design-product__title",
        duration: 1,
        y: 20,
        opacity: 0,
        delay: .3,
    ...
    gsap.from(".design-product__subtext", {
        scrollTrigger: ".design-product__subtext",
        duration: 1.2,
        opacity: 0,
        delay: .4,
        ease: "power3.inOut"
    });
    gsap.from(".inner__text", {
        scrollTrigger: ".inner__text",
        duration: 1,
        x: -30,
        opacity: 0,
        delay: .5,
    ...
    gsap.from(".inner__details", {
        scrollTrigger: ".inner__details",
        duration: 1,
        scale: .95,
        opacity: 0,
        delay: .8,
    ...
    gsap.registerPlugin(ScrollTrigger);
    document.querySelectorAll(".link__item-text").forEach((function(triggerElement) {
    ...
    gTl.to(".studio__image", {
        clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",
        duration: 2.1,
        ease: "expo.out"
    });
    gsap.from(".studio__description", {
        scrollTrigger: {
            trigger: ".studio__image",
            start: "top bottom"
        },
    ...
    gsap.from(".design__subtext", {
        scrollTrigger: {
            trigger: ".design__subtext",
            start: "top 90%"
        },
        duration: 1.2,
        x: 30,
    ...
    gsap.from(".design__slider", {
        scrollTrigger: ".design__slider",
        duration: 1.6,
        delay: .9,
        x: -40,
        opacity: 0,
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.from(".decor-about__star", {
        scrollTrigger: ".decor-about__star",
        duration: 1.5,
        scale: .8,
        opacity: 0,
        ease: "power1.out"
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.from(".catch-glimse__text", {
        scrollTrigger: ".catch-glimse__text",
        duration: 1.2,
        y: -40,
        opacity: 0,
        ease: "power3.out",
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.from(".header-project__title", {
        scrollTrigger: {
    ...
    gsap.from(".project-top__item", {
        scrollTrigger: {
            trigger: ".project__top",
            start: "top center"
        },
        duration: 1.5,
        y: 50,
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.from(".decor-footer__circle", {
        scrollTrigger: {
            trigger: ".footer__decor",
            start: "top bottom"
        },
        duration: 1,
        scale: .8,
    ...
    gsap.from(".copyrate-footer", {
        scrollTrigger: {
            trigger: ".footer__copyrate",
            start: "top bottom"
        },
        duration: 1,
        y: 20,
    ...
    gsap.from(".clip-center .marquee", 4.5, {
        delay: 1,
        opacity: .9,
        left: "-100%",
        ease: "power3.inOut"
